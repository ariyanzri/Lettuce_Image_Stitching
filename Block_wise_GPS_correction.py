...
def get_best_neighbor_old_method(p1,corrected):
	...
	for p_tmp in corrected_neighbors:
		...
		if (best_params is None) or (params is not None and params.num_matches*params.percentage_inliers > best_params.num_matches*best_params.percentage_inliers and  params.dissimilarity < best_params.dissimilarity):
			best_params = params
			best_p = p_tmp
