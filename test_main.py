...
def main(scan_date):
	...
	old_RMSE = get_approximate_random_RMSE_overlap(field,20,settings.no_of_cores_to_use_max)
...
settings.initialize_settings_test(scan_date,config_file,local_address,20,None)
